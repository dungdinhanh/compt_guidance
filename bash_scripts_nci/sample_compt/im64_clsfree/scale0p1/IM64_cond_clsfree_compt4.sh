...
#PBS -o output_nci/compt64_clsfree_scale0p1_log4.txt
#PBS -e output_nci/compt64_clsfree_scale0p1_error4.txt
...
do
  for skip in "${skips[@]}"
  do
cmd="WORLD_SIZE=1 RANK=0 MASTER_IP=127.0.0.1 MASTER_PORT=30517 MARSV2_WHOLE_LIFE_STATE=0 python3  scripts_gdiff/compt_guidance/classifier_free_compt_sample.py $MODEL_FLAGS  \
