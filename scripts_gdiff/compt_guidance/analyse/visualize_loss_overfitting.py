...
def visualize2(guidance_losses_training, guidance_losses_testing, compact_losses_training, compact_losses_testing,
    ...
    plt.plot(timesteps, guidance_losses_testing, '--', label="Off-sampling loss", linewidth=2.5)
...
if __name__ == '__main__':
    ...
    compact_file = "../selfsup-guidance/runs/sampling_compt2quad_visualize_overfitting_imn64test2/IMN64_withxt_below5/unconditional/scale22.0_skip5/reference/loss.npz"

    glt, gltest, clt, cltest = read_file(guidance_file, compact_file)
    out_folder = "runs/analayse"
    os.makedirs(out_folder, exist_ok=True)

    out_file = os.path.join(out_folder, "loss_visualize_overfitting_problem.pdf")
    print(out_file)
