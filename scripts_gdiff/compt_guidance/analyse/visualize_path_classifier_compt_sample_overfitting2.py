...
def main(local_rank):
    ...
    classifier2 = create_classifier(**dict_args_cls2)
    classifier2.load_state_dict(
        dist_util.load_state_dict(os.path.join(base_folder, "models/128x128_classifier.pt"), map_location="cpu")
    )
    ...
    def cond_fn(inputs, t, y=None):
        ...
        with th.enable_grad():
            ...
            p_x_t = classifier2(x_in_enlarge, t)
