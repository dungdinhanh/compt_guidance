...
def main(local_rank):
    ...
    guidance_timesteps, compression_steps = get_guidance_timesteps_with_weight(timespace, skip, args.k)
    ...
    def cond_fn(x, t, y=None):
        ...
        with th.enable_grad():
            ...
            if guidance_timesteps[convert_t] > 0:
                ...
                check_scale = args.classifier_scale * guidance_timesteps[convert_t] * compression_steps[convert_t]
                print(f"{t[0]}, {check_scale}")
                return th.autograd.grad(selected.sum(), x_in)[0] * args.classifier_scale * guidance_timesteps[convert_t] * compression_steps[convert_t]
            else:
