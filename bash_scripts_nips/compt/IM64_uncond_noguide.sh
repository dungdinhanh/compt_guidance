...
SAMPLE_FLAGS="--batch_size 80 --num_samples 60 --timestep_respacing 250"
...
do
  for skip in "${skips[@]}"
  do
cmd="python3 scripts_gdiff/compt_guidance/classifier_compt_sample_noguidance_time.py $MODEL_FLAGS --classifier_scale ${scale}  \
