...
SAMPLE_FLAGS="--batch_size 15 --num_samples 15 --timestep_respacing 250 "
...
do
  for skip in "${skips[@]}"
  do
cmd="python scripts_gdiff/compt_guidance/classifier_compt_sample_noguidance_time.py \
 ...
 --logdir runs/sampling_compt2t/IMN256/unconditional/scale${scale}_skip${skip}/ \
