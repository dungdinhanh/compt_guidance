...
class GaussianDiffusionClassFree2_Compt(GaussianDiffusionClassFree):
    def __init__(self,
        use_timesteps,
        *,
        betas,
        ...
        super(GaussianDiffusionClassFree2_Compt, self).__init__(use_timesteps=use_timesteps, betas=betas,
                                                   model_mean_type=model_mean_type,
                                                   model_var_type=model_var_type,
                                                   loss_type=loss_type,
                                                   rescale_timesteps=rescale_timesteps)
    ...
    def condition_mean_mtl(self, cond_fn, p_mean_var, x, t, w=0.5, clip_denoised=True, denoised_fn=None,
        ...
        This uses the conditioning strategy from Sohl-Dickstein et al. (2015).
        """
        if (t[0]+1) % self.skip_compt == 0 or t[0] <= 1:
