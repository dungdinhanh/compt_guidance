...
def create_model_and_diffusion_classifier_free2_compt(
    image_size,
    class_cond,
    learn_sigma,
    num_channels,
    ...
    diffusion = create_gaussian_diffusion_clsfree2_compt(
        steps=diffusion_steps,
        learn_sigma=learn_sigma,
        noise_schedule=noise_schedule,
        use_kl=use_kl,
...
def create_gaussian_diffusion_clsfree2_compt(
    *,
    steps=1000,
    learn_sigma=False,
    sigma_small=False,
    ...
    if not timestep_respacing:
        timestep_respacing = [steps]
    return GaussianDiffusionClassFree2_Compt(
        use_timesteps=space_timesteps(steps, timestep_respacing),
        betas=betas,
        model_mean_type=(
            gd.ModelMeanType.EPSILON if not predict_xstart else gd.ModelMeanType.START_X
...
def create_model_and_diffusion_classifier_free2_comptquad(
    image_size,
    class_cond,
    learn_sigma,
    num_channels,
    ...
    diffusion = create_gaussian_diffusion_clsfree2_comptquad(
        steps=diffusion_steps,
        learn_sigma=learn_sigma,
        noise_schedule=noise_schedule,
        use_kl=use_kl,
...
def create_gaussian_diffusion_clsfree2_comptquad(
    *,
    steps=1000,
    learn_sigma=False,
    sigma_small=False,
    ...
    if not timestep_respacing:
        timestep_respacing = [steps]
    return GaussianDiffusionClassFree2_ComptQuad(
        use_timesteps=space_timesteps(steps, timestep_respacing),
        betas=betas,
        model_mean_type=(
            gd.ModelMeanType.EPSILON if not predict_xstart else gd.ModelMeanType.START_X
